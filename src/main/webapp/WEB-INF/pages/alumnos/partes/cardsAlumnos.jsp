        ...
        <div class="card h-100">
            ...
            <div class="card-footer">
                <div class="row justify-content-center">
                    <div class="col-4">
                        <a href="${pageContext.request.contextPath}/app?accion=read&id=${alumno.id}" class="btn bg-info w-100"><i class="bi bi-eye"></i></a>
                    </div>
                    <div class="col-4">
...
<!--     <jsp:include page="modalMostrarAlumno.jsp"/> 
  "${pageContext.request.contextPath}/tarea.jsp " -->
